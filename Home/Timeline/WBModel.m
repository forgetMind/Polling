...
@implementation WBVoteEnty

+ (NSDictionary *)modelCustomPropertyMapper {
    return @{@"optionDescription" : @"option_description",
             @"votes" : @"votes",
             @"voteColor" : @"vote_color",
             @"isVoted" : @"is_voted"};
}

@end

@implementation WBVote
+ (NSDictionary *)modelCustomPropertyMapper {
    return @{@"idString" : @"voteId_string",
...
+ (NSDictionary *)modelContainerPropertyGenericClass {
    return @{@"voteEntys" : [WBVoteEnty class]};
}
