...
#define kWBCellVoteViewPadding 8         // vote view 上下留白
#define kWBCellVoteEntyHeight 88    // Vote Enty 视图高度
#define kWBCellVoteEntyPadding 12    // Vote Enty 间隔高度
...
#define kWBVoteEntyFontSize 15 // 工具栏字体大小
...
// 投票
@property (nonatomic, assign) CGFloat voteHeight; //view高度，0为没有
@property (nonatomic, assign) CGSize votesSize;
...
@property (nonatomic, assign) CGFloat retweetVoteHeight;      //被转发的投票条目视图高度
@property (nonatomic, assign) CGSize retweetVotesSize;         //被转发的投票视图size
