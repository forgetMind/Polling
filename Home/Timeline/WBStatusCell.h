...
@interface WBVoteEntyView : UIView
//@property (nonatomic, strong) YYLabel *descriptionLabel;           // 投票选项描述
@property (nonatomic, strong) YYLabel *ratioLabel;
@property (nonatomic, strong) UIButton *voteButton;
@property (nonatomic, weak) WBStatusCell *cell;
@end

@interface WBVoteView : UIView
@property (nonatomic, strong) NSArray<WBVoteEntyView *> *voteViews;      // 投票选项视图
/**
 *  投票信息描述，例如:
    100340次投票-还剩22小时45分钟
    16/8/19 12:34
 */
@property (nonatomic, strong) YYLabel *voteInfoLabel;
...
@property (nonatomic, strong) WBVoteView *voteView;             // 投票视图
@property (nonatomic, strong) WBStatusCardView *cardView;       // 卡片,只在转发的时候才出现
