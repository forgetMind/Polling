...
/**
 投票项数据
 */
@interface WBVoteEnty : NSObject
@property (nonatomic, strong) NSString *voteEntyID;
@property (nonatomic, strong) NSString *optionDescription; ///描述
@property (nonatomic, assign) uint64_t votes; /// 投票数
@property (nonatomic, assign) int32_t *voteColor; /// 投票项颜色
@property (nonatomic, assign) BOOL isSelected; /// 该选项是否已经投过票
@end
...
/**
 投票数据
 */
@interface WBVote : NSObject
@property (nonatomic, strong) NSString *idString; ///< id (string)
@property (nonatomic, assign) BOOL isVoted; /// 是否已经投过票
@property (nonatomic, assign) uint64_t totalVotes; /// 投票总数
@property (nonatomic, strong) NSString *startVoteTime; /// 投票的起始时间
@property (nonatomic, strong) NSString *voteTime; /// 投票总时间
@property (nonatomic, strong) NSString *remainingTime; ///投票剩余时间
@property (nonatomic, strong) NSArray<WBVoteEnty *> *voteEntys;//投票选项数据
@end
...
@property (nonatomic, strong) NSArray<NSString *> *picIds;//图片数组以图片id为key，数组内包含图片的信息
@property (nonatomic, strong) NSDictionary<NSString *, WBPicture *> *picInfos;
...
//投票的选项数量
@property (nonatomic, strong) NSArray<WBVoteEnty *> *votes;
